export default function ChatMessage({ role, content, type, onConfirm, onCancel, confirmDisabled }) {
  if (type === 'confirm') {
    return (
      <div className="my-2">
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="px-4 pb-4 flex gap-2">
            <button
              ...
              className="flex-1 py-2 text-sm text-white rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              onClick={onCancel}
              disabled={confirmDisabled}
              className="flex-1 py-2 text-sm bg-slate-100 text-slate-600 rounded-xl font-medium hover:bg-slate-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
          </div>
